...
import static tech.sangdang.lmscoreapi.modules.classroom.support.ClassroomMemberFixtures.MEMBER_EMAIL;
import static tech.sangdang.lmscoreapi.modules.classroom.support.ClassroomMemberFixtures.MEMBER_ID;
import static tech.sangdang.lmscoreapi.modules.classroom.support.ClassroomMemberFixtures.MEMBER_NAME;
...
import tech.sangdang.lmscoreapi.modules.classroom.app.impl.ClassroomMemberServiceImpl;
import tech.sangdang.lmscoreapi.modules.classroom.app.mappers.ClassroomMemberMapperImpl;
...
class ClassroomMemberControllerIntegrationTest {
  ...
  void createClassroomMember_reactivatesRemoved_returns201() throws Exception {
    ...
    assertThat(captor.getValue().getRole())
        .isEqualTo(tech.sangdang.lmscoreapi.modules.classroom.dom.ClassroomMemberRole.TEACHER);
    verify(classroomMemberRepository, never()).insert(any());
  }
  ...
  void updateClassroomMemberRole_valid_returns200() throws Exception {
    ...
    verify(classroomMemberRepository).update(captor.capture());
    assertThat(captor.getValue().getRole())
        .isEqualTo(tech.sangdang.lmscoreapi.modules.classroom.dom.ClassroomMemberRole.ADMIN);
  }
