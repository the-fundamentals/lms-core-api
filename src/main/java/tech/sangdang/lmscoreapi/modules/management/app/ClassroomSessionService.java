...
public interface ClassroomSessionService {
   ...
   *   <li>PATCHWORK: if the filter has both a sessionDate start and end, generates missing schedule
   *       sessions for that window first. Will be updated in the future.
   * </ul>
   *
